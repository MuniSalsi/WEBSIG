...
function initMap() 
{
   ...
   var glng = getParameterByName('lng');
	...
	if (glat==null) {glat = -31.138363428195888;} else if (glat==''){glat = -31.138363428195888;}
  	if (glng==null) {glng = -64.29185319391786;} else if (glng=='') {glng = -64.29185319391786;}
	//alert(gcalle + ' ' +gnro);
	var geocoder = new google.maps.Geocoder();
	var address = gcalle + " " + gnro + ", Salsipuedes, Cordoba, Argentina";
  ...
  var SLPLayer = new google.maps.ImageMapType({
    getTileUrl: function(coord, zoom) {
      ...
      var url = "http://sp.d2g.com:8877/geoserver/Salsipuedes/wms?";
      url += "SERVICE=WMS"; //WMS service
      url += "&REQUEST=GetMap"; //WMS operation
      url += "&VERSION=1.1.1"; //WMS version  
      url += "&LAYERS=Salsipuedes:finanzas"; //WMS layers
