...
function initMap() 
{
   ...
   var miZoom = 18;
	...
	{		
		...
		$.ajax({
                url: "http://192.141.209.201:9977/sig/getCuenta.php",
                type: 'POST',
				async: false,				
                data:{
                    "cuenta": cuenta,
  ...
  */
  ...
  var SLPLayer = new google.maps.ImageMapType({
    getTileUrl: function(coord, zoom) {
      ...
      var url = "http://geoserver.salsipuedes.gob.ar:8877/geoserver/Salsipuedes/wms?";
      url += "SERVICE=WMS"; //WMS service
      url += "&REQUEST=GetMap"; //WMS operation
      url += "&VERSION=1.1.0"; //WMS version  
      url += "&LAYERS=Salsipuedes:piletas"; //WMS layers
