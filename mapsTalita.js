...
function initMap() 
{
   ...
   var glng = getParameterByName('lng');
	...
	if (glat==null) {glat = -31.140824450045024;} else if (glat==''){glat = -31.140824450045024;}
  	if (glng==null) {glng = -64.2647736117035;} else if (glng=='') {glng = -64.2647736117035;}
	//alert(gcalle + ' ' +gnro);
  ...
  var SLPLayer = new google.maps.ImageMapType({
    getTileUrl: function(coord, zoom) {
      ...
      url += "&LAYERS=Salsipuedes:eltalita"; //WMS layers
